...
interface HeroProps {
  ...
  return (
    <div className='bg-gradient-to-r gap-12 md:gap-24 from-[#1E1629] w-full via-[#FF00EA] px-2 md:px-16 to-[#1E1629]   border-[#FF00EA] border-1 rounded-4xl backdrop-blur-2xl  shadow-[#1E1629] shadow-2xl mt-10 flex flex-col lg:flex-row justify-between'>
      ...
      <div className='md:pt-20 pb-20 flex flex-col text-center items-center md:w-auto w-full'>
        <div>
